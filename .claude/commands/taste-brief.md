Generate or update this project's Taste Brief.

1. If references/taste-brief.md has content beyond placeholders, show current state.
...
3. Synthesize into Taste Brief.
4. Save to .claude/skills/taste-engineering/references/taste-brief.md
5. Update CLAUDE.md Project Identity fields.
6. Confirm: "Taste anchors set. All agents now enforce these standards."
